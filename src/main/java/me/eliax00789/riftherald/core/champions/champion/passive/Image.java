package me.eliax00789.riftherald.core.champions.champion.passive;
...
public class Image {
    ...
    public String fullURL() {
        try {
            return "https://ddragon.leagueoflegends.com/cdn/" + Version.getInstance().get() + "/img/passive/" + data.getString("full");
