package me.eliax00789.riftherald.core.missionassets.missionasset;
...
public class Image {
    ...
    public String fullURL() {
        try {
            return "https://ddragon.leagueoflegends.com/cdn/" + Version.getInstance().get() + "/img/mission/" + data.getString("full");
