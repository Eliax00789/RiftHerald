package me.eliax00789.riftherald.core.profileicons.profileicon;
...
public class Image {
    ...
    public String fullURL() {
        try {
            return "https://ddragon.leagueoflegends.com/cdn/" + Version.getInstance().get() + "/img/profileicon/" + data.getString("full");
